...
class _PenitipProfileState extends State<PenitipProfile> {
  ...
  Future<Penitip?> _fetchPenitipProfile() async {
    ...
    if (result['success']) {
      return Penitip.fromJson(result['data']['penitip']); // 👈 sesuai response structure
    } else {
      return null;
    }
  }
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Penitip?>(
       ...
       builder: (context, snapshot) {
          ...
          final status = penitip.status_aktif ? 'Aktif' : 'Nonaktif';
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Info fields
                _buildProfileField(Icons.phone, 'Nomor Telepon', penitip.notelp),
                _buildProfileField(Icons.credit_card, 'Nomor KTP', penitip.no_ktp),
                ...
                _buildProfileField(Icons.account_balance_wallet, 'Saldo', 'Rp ${penitip.saldo_penitip.toStringAsFixed(2)}'),
