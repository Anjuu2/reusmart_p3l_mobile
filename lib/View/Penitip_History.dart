...
class _PenitipHistoryPageState extends State<PenitipHistoryPage> {
  ...
  void initState() {
    ...
    _searchController.addListener(() {
      ...
      _fetchHistory(); // Reset dengan search baru
    });
  }
  ...
  void _debounceFetch() {
    ...
    _debounce = Timer(const Duration(milliseconds: 500), () {
      _fetchHistory(); // panggil setelah user berhenti mengetik selama 500ms
    });
  }
                    ...
                    children: [
                      Expanded(
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            _debounceFetch(); // opsional: debounce agar fetch tidak terlalu sering
                          },
                        ),
                      ),
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          onChanged: (newValue) {
                            setState(() {
                              ...
                              _fetchHistory(); // panggil ulang data dengan filter baru
                            });
                          },
                          decoration: const InputDecoration(
                            labelText: 'Status',
